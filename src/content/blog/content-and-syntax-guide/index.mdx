...
```md
[Link to public file using relative path](../resume/milidev_resume.pdf)
```
...
<MdxPublicLink href="/resume/milidev_resume.pdf">Link to public file using a dedicated Astro component</MdxPublicLink>
```
