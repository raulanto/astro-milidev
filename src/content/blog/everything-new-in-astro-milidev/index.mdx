...
Navigate to the [Getting started](../getting-started) post to read how to handle [images](../getting-started#public-images) and [links](../getting-started#relative-links).
