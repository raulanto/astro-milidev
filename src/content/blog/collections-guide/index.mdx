---
title: "How to add a collection entry"
...
They work pretty much the same. You can remove those you don't need or add a new one basing on the way they're integrated with the rest of the page.
...
- [Markdown syntaxt guide](markdown-syntax-guide)
