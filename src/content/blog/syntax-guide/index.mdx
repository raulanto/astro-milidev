...
If you want to link to another page on your site, you might want use a relative link.
...
It might not work locally (in both dev and preview mdoes) and I have no idea why, I'm a purely backend engineer. It works fine in production, though.
Yes, I know `<base>` tag, but setting it breaks other things e.g.: Table of Contents.
</Callout>
...
Relative paths work fine with link (they don't with images, [see why](#public-image)):

```md
[Link to public file using relative path](../resume/resume.pdf)
```
...
<MdxPublicLink href="/resume/resume.pdf">Link to public file using a dedicated Astro component</MdxPublicLink>
```
