...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": entry.data.title, "description": entry.data.description, "ogImage": entry.data.ogImage }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Container", $$Container, {}, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<div class="animate"> ${renderComponent($$result3, "BackToPrevious", $$BackToPrevious, { "href": resolvePath("/projects", Astro2.url.pathname) }, { "default": ($$result4) => renderTemplate`All projects` })} </div>  ${headings?.length ? renderTemplate`${renderComponent($$result3, "TableOfContents", $$TableOfContents, { "headings": headings })}` : void 0}<article class="animate"> <hr> ${renderComponent($$result3, "Content", Content, {})} </article> ` })} ` })}`;
}, "/Users/jonathan/Documents/GitHub/astro-milidev/src/pages/projects/[...slug].astro", void 0);

const $$file = "/Users/jonathan/Documents/GitHub/astro-milidev/src/pages/projects/[...slug].astro";
const $$url = "/astro-milidev/projects/[...slug]";
